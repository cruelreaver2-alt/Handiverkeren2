        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#17384E] to-[#2a5570] text-white px-4 py-2 rounded-full mb-4">
              ...
              <span className="font-semibold">For kunder</span>
            </div>
            <h2 className="text-2xl font-bold text-[#111827]">Helt gratis å bruke</h2>
          </div>

          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-lg border-2 border-[#E07B3E] p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-[#E07B3E] text-white px-4 py-1 text-sm font-semibold">
                ANBEFALT
              </div>
