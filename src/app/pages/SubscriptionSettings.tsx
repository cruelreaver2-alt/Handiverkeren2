    ...
    <div className="min-h-screen bg-[#F3F4F6]">
      ...
      <div className="bg-white border-b border-[#E5E7EB]">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#111827]">Abonnementsinnstillinger</h1>
              <p className="text-sm text-[#6B7280]">Administrer ditt abonnement</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg border border-[#E5E7EB] p-6 mb-6">
          <h2 className="text-lg font-bold text-[#111827] mb-4">Din nåværende plan</h2>
        ...
        <div className="bg-gradient-to-br from-[#17384E] to-[#2a5570] rounded-lg p-6 mb-6 text-white">
          <div className="flex items-center gap-2 mb-3">
            <span className="px-2 py-1 bg-[#E07B3E] text-white text-xs font-bold rounded">DEV</span>
            <h2 className="text-lg font-bold">Test subscription tiers</h2>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {plans.map((plan) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-6 h-6 mx-auto mb-2 ${isActive ? "text-[#E07B3E]" : ""}`} />
                  <div className={`font-bold mb-1 ${isActive ? "" : "opacity-90"}`}>
                    {plan.name}
                  </div>
                  <div className={`text-sm ${isActive ? "" : "opacity-75"}`}>
                    {plan.price} kr
                  </div>
                  {isActive && (
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          <button
            onClick={() => navigate("/bygg-tilbud/test-123")}
